...
<head>
    ...
    <meta name="description" content="Live scoreboard - {{ $eventner?->nama_event ?? get_setting('site_title', 'Berbaris App') }}. Pantau skor dan peringkat peserta secara real-time.">
    ...
    <title>{{ $eventner?->nama_event ?? get_setting('site_title', 'Berbaris App') }} - Live Scoreboard</title>

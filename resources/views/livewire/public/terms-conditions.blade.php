        ...
        <div class="max-w-3xl mx-auto">
            <div class="surface-card p-8 md:p-10">
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-deep-slate mb-3">2. Pendaftaran & Akun</h2>
                        <ul class="space-y-2 text-on-surface-variant list-disc pl-5">
                            <li>Pengguna wajib memberikan informasi yang akurat dan lengkap saat pendaftaran</li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-on-surface-variant list-disc pl-5">
                            ...
                            <li>Sistem penilaian (scoring) dan penentuan juara</li>
                            <li>Pengundian peserta (drawing) digital</li>
                            <li>Rekapitulasi nilai dan hasil kompetisi</li>
                        </ul>
                    </div>

                    <div>
                        <h2 class="text-xl font-bold text-deep-slate mb-3">4. Pembayaran & Transaksi</h2>
                        <ul class="space-y-2 text-on-surface-variant list-disc pl-5">
                            <li>Semua transaksi pembayaran diproses melalui payment gateway pihak ketiga (Xendit)</li>
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-deep-slate mb-3">5. Hak & Kewajiban Pengguna</h2>
                        <p class="text-on-surface-variant leading-relaxed mb-2"><strong class="text-deep-slate">Hak Pengguna:</strong></p>
                        <ul class="space-y-2 text-on-surface-variant list-disc pl-5 mb-4">
                            <li>Mengakses dan mengelola data pendaftaran masing-masing</li>
                            <li>Melihat hasil kompetisi dan rekapitulasi penilaian</li>
                            <li>Menghubungi support untuk bantuan teknis</li>
                        </ul>
                        <p class="text-on-surface-variant leading-relaxed mb-2"><strong class="text-deep-slate">Kewajiban Pengguna:</strong></p>
                        <ul class="space-y-2 text-on-surface-variant list-disc pl-5">
                            <li>Tidak menyalahgunakan fitur platform</li>
                            <li>Tidak melakukan kecurangan dalam voting atau kompetisi</li>
                            <li>Menghormati data dan privasi peserta lain</li>
                            <li>Melaporkan bug atau masalah keamanan kepada admin</li>
                        </ul>
                    </div>
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-deep-slate mb-3">7. Pembatasan Layanan</h2>
                        <p class="text-on-surface-variant leading-relaxed">Kami berhak untuk melakukan pemeliharaan, pembaruan, atau modifikasi pada platform tanpa pemberitahuan terlebih dahulu. Dalam keadaan tertentu, layanan mungkin tidak tersedia sementara. Kami akan berusaha memberikan pemberitahuan untuk downtime yang dijadwalkan.</p>
                    </div>
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-deep-slate mb-3">9. Perubahan Ketentuan</h2>
                        <p class="text-on-surface-variant leading-relaxed">Kami berhak mengubah Syarat & Ketentuan ini kapan saja. Penggunaan platform setelah perubahan dianggap sebagai persetujuan terhadap ketentuan yang diperbarui. Perubahan akan diinformasikan melalui platform.</p>
                    </div>

                    <div>
                        <h2 class="text-xl font-bold text-deep-slate mb-3">10. Hubungi Kami</h2>
                        <p class="text-on-surface-variant leading-relaxed">Untuk pertanyaan mengenai Syarat & Ketentuan ini, silakan hubungi kami melalui halaman <a href="{{ route('help') }}" class="text-primary font-bold hover:underline">Bantuan & Support</a>.</p>
                    </div>
                </div>
            </div>
        </div>

        ...
        <div class="custom-container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center text-lg-start">
                    <span class="badge bg-primary text-white mb-3 px-3 py-2 fw-semibold">Portal Pendaftaran Mandiri</span>
                    <h1 class="text-dark fw-semibold fs-10 mb-3">
                        Kelola Pendaftaran
                    </h1>
                    ...
                    <div class="mt-3">
                        ...
                        <strong class="text-dark">{{ $registration->nama_sekolah }}</strong>
                        <span class="text-muted ms-2">NPSN:</span>
                        <strong class="text-dark">{{ $registration->npsn }}</strong>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link {{ $activeRegId == $sib->id ? 'active bg-primary text-white' : '' }}"
                                        ...
                                        @if($sib->participants->count() > 0)
                                            <span class="badge {{ $activeRegId == $sib->id ? 'bg-white text-primary' : 'bg-primary' }} ms-1">{{ $sib->participants->count() }}</span>
                                        @endif
                                    </button>
                                </li>
                            @endforeach
                        ...
                        <div class="card-body p-3">
                            <div class="d-flex flex-wrap gap-2">
                                <span class="badge bg-light text-dark px-2 py-1">
                                    <i class="ti ti-school me-1"></i>{{ $registration->nama_sekolah }}
                                </span>
                        ...
                        <div class="card w-100 mb-4 border-primary">
                            <div class="card-body p-4">
                                ...
                                @if($registration->eventner->technical_meeting && now()->lt($registration->eventner->technical_meeting))
                                    <div class="bg-warning-subtle p-3 rounded mb-4">
                                ...
                                @else
                                    <div class="bg-success-subtle p-3 rounded mb-4">
                                        <p class="mb-0 text-dark small">
                    ...
                    <fieldset {{ $isLocked ? 'disabled' : '' }}>
                        ...
                        <div class="card w-100 mb-4">
                            <div class="card-body p-4">
                                <h5 class="fw-semibold mb-3 border-bottom pb-2"><i class="ti ti-user me-2"></i>Data Pelatih</h5>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        @error('namaPelatih') <span class="text-danger small">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @error('fotoPelatih') <span class="text-danger small">{{ $message }}</span> @enderror
                                        @if($registration->foto_pelatih)
                                            <span class="text-success small mt-1 d-block"><i class="ti ti-check me-1"></i>Sudah diunggah</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <form wire:submit.prevent="submit(false)">
                            ...
                            <div class="card w-100 mb-4">
                                <div class="card-body p-4">
                                    <h5 class="fw-semibold mb-3 border-bottom pb-2"><i class="ti ti-file-text me-2"></i>Berkas Persyaratan</h5>
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            @error('logoSekolah') <span class="text-danger small">{{ $message }}</span> @enderror
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @error('suratTugas') <span class="text-danger small">{{ $message }}</span> @enderror
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @error('buktiPendaftaran') <span class="text-danger small">{{ $message }}</span> @enderror
                            ...
                            <div class="card w-100 mb-4">
                                <div class="card-body p-4">
                                    <h5 class="fw-semibold mb-3 border-bottom pb-2"><i class="ti ti-star text-warning me-2"></i>Komandan Pleton (Danton)</h5>
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            @error('dantonNama') <span class="text-danger small">{{ $message }}</span> @enderror
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label fw-semibold">NISN</label>
                                            <input type="text" class="form-control" wire:model="dantonNisn" placeholder="NISN...">
                                            @error('dantonNisn') <span class="text-danger small">{{ $message }}</span> @enderror
                                        </div>
                                        <div class="col-md-5">
                                            <label class="form-label fw-semibold">Pas Foto</label>
                                            <input type="file" class="form-control" wire:model="dantonFoto" accept="image/*">
                                            @error('dantonFoto') <span class="text-danger small">{{ $message }}</span> @enderror
                                    ...
                                    @foreach($participants as $index => $participant)
                                        <div class="row g-2 mb-3 pb-3 border-bottom align-items-start">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control form-control-sm" wire:model="participants.{{ $index }}.nama" placeholder="Nama lengkap...">
                                                @error('participants.'.$index.'.nama') <span class="text-danger small">{{ $message }}</span> @enderror
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-label small fw-semibold">NISN</label>
                                                <input type="text" class="form-control form-control-sm" wire:model="participants.{{ $index }}.nisn" placeholder="NISN...">
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label small fw-semibold">Pas Foto</label>
                            ...
                            @else
                                <div class="text-center mb-5">
                                    @if($registration->status_berkas === 'Terverifikasi')
                                        <span class="badge bg-success-subtle text-success border border-success px-4 py-2 fs-3">
                                            <i class="ti ti-circle-check me-1"></i> TERVERIFIKASI PANITIA
                                        </span>
                                    @else
                                        <span class="badge bg-info-subtle text-info border border-info px-4 py-2 fs-3">

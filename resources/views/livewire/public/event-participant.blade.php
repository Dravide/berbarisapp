            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    @if($eventner->logo_event)
                        <img src="{{ asset('storage/' . $eventner->logo_event) }}" class="rounded-circle border border-3 border-white shadow mb-3" width="80" height="80" style="object-fit:cover;" alt="">
                    @endif
                    <span class="badge bg-primary text-white mb-3 px-3 py-2 rounded-pill">Kontingen Peserta</span>
                    <h1 class="text-dark fw-bolder fs-10 mb-2">Daftar Sekolah Terdaftar</h1>
        ...
        <div class="custom-container">
            <div class="row justify-content-center g-3 mb-5">
                <div class="col-md-3 col-6">
                    <div class="card border-0 shadow-sm rounded-4 text-center h-100 mb-0">
                        <div class="card-body py-4">
                            ...
                            <h3 class="fw-bolder text-dark mb-0">{{ $eventner->competitionCategories->count() }}</h3>
                ...
                <div class="col-md-3 col-6">
                    <div class="card border-0 shadow-sm rounded-4 text-center h-100 mb-0">
                        <div class="card-body py-4">
                            ...
                            <h3 class="fw-bolder text-dark mb-0">{{ $totalKontingen }}</h3>
                ...
                <div class="col-md-3 col-6">
                    <div class="card border-0 shadow-sm rounded-4 text-center h-100 mb-0">
                        <div class="card-body py-4">
                            <div class="bg-light-warning rounded-circle d-inline-flex align-items-center justify-content-center mb-2" style="width:48px;height:48px;">
                                <i class="ti ti-users fs-6 text-warning"></i>
                            </div>
                            <h3 class="fw-bolder text-dark mb-0">{{ $totalAnggota }}</h3>
                ...
                <div class="card shadow-sm border-0 rounded-4 mb-4 overflow-hidden">
                    ...
                    <div class="card-body p-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-3">
                                                    @if($reg->logo_sekolah)
                                                        <img src="{{ asset('storage/' . $reg->logo_sekolah) }}" class="rounded-circle border shadow-sm" width="44" height="44" style="object-fit:cover;" alt="">
                                                    @else
                                                        <div class="bg-primary-subtle text-primary rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="width:44px;height:44px;">
                                            ...
                                            <td class="text-center">
                                                <span class="badge bg-info-subtle text-info fs-3 px-3 py-2 rounded-pill">
                                                    <i class="ti ti-users me-1"></i> {{ $reg->participants->count() }}
                                                </span>
                                            </td>
                                            <td class="text-center">
                                                @if($reg->status_berkas === 'Terverifikasi')
                                                    <span class="badge bg-success-subtle text-success fs-3 px-3 py-2 rounded-pill"><i class="ti ti-circle-check me-1"></i> Terverifikasi</span>
                                                @elseif($reg->status_berkas === 'Ditolak')
                                                    <span class="badge bg-danger-subtle text-danger fs-3 px-3 py-2 rounded-pill"><i class="ti ti-circle-x me-1"></i> Ditolak</span>
                                                @else
                                                    <span class="badge bg-warning-subtle text-warning fs-3 px-3 py-2 rounded-pill"><i class="ti ti-clock me-1"></i> Menunggu</span>
                                                @endif
                                            </td>
                                        </tr>
                                        @endforeach
                        ...
                        <div class="d-md-none p-3">
                            @foreach($cat->registrations as $idx => $reg)
                            <div class="border rounded-3 p-3 mb-2 bg-white {{ !$loop->last ? '' : '' }}">

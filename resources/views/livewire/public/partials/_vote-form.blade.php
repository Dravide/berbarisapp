    ...
    <form wire:submit.prevent="submitVote">
        ...
        <div style="margin-bottom: 18px;">
            ...
            <div style="display: flex;">
                <button type="button" wire:click="$set('voteCount', {{ max(1, $voteCount - 1) }})" style="background: #fff; border: 1px solid #e5e7eb; border-radius: 10px 0 0 10px; width: 48px; height: 48px; cursor: pointer; font-size: 20px; color: var(--event-primary, #0072FF); display: flex; align-items: center; justify-content: center;">−</button>
                ...
                <button type="button" wire:click="$set('voteCount', {{ $voteCount + 1 }})" style="background: #fff; border: 1px solid #e5e7eb; border-radius: 0 10px 10px 0; width: 48px; height: 48px; cursor: pointer; font-size: 20px; color: var(--event-primary, #0072FF); display: flex; align-items: center; justify-content: center;">+</button>
            </div>

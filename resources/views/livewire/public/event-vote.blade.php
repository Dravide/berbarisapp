            ...
            <div class="grid gap-8 lg:grid-cols-12">
                ...
                <div class="{{ $eventner->vote_active ? 'lg:col-span-8' : 'lg:col-span-12' }}">
                    @if($view == 'categories')
                        ...
                        {{-- ===== TOP 10 PENDUKUNG (seluruh kategori) ===== --}}
                        @php $topSupporters = $this->topSupporters; @endphp
                        @if($topSupporters->isNotEmpty())
                            <div class="surface-card mt-8 border border-outline-variant/50 bg-white overflow-hidden">
                                <div class="px-5 py-4 border-b border-outline-variant/30 flex items-center justify-between gap-3">
                                    ...
                                    <span class="text-[10px] font-bold text-on-surface-variant uppercase tracking-wider">Semua kategori · berdasarkan email</span>
                                </div>
                                <div class="p-4">
                                    ...
                                    <p class="text-[10px] text-on-surface-variant text-center mt-3 mb-0">Total vote seluruh kategori digabung berdasarkan email pendukung (PAID).</p>
                                </div>
                            </div>
                        @endif
                    @else

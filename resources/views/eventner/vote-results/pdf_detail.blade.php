...
<head>
    <meta charset="UTF-8">
    <title>Detail Voting - {{ $registration->display_name }}</title>
    <style>
        @font-face {
            font-family: 'PJ';
...
<body>
    ...
    <table class="kontingen">
        <tr>
            <td style="width: 40%;">
                ...
                <span class="value">{{ $registration->display_name }}</span>
            </td>
            <td style="width: 30%;">
    ...
    <div class="foot">
        {{ $eventner->nama_event }} &mdash; Detail Voting {{ $registration->display_name }} &mdash; Dicetak {{ now()->translatedFormat('d M Y H:i') }} &mdash; Generated by BARIS APP
    </div>
</body>
</html>
